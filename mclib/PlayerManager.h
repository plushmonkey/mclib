...
public:
    MCLIB_API PlayerManager(Packets::PacketDispatcher* dispatcher, EntityManager* entityManager);
    ...
    void MCLIB_API HandlePacket(Packets::Inbound::LoginSuccessPacket* packet);
    void MCLIB_API HandlePacket(Packets::Inbound::PlayerPositionAndLookPacket* packet);
    void MCLIB_API HandlePacket(Packets::Inbound::PlayerListItemPacket* packet);
};
