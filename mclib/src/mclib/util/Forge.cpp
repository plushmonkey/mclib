...
ForgeHandler::ForgeHandler(protocol::packets::PacketDispatcher* dispatcher, core::Connection* connection)
    : protocol::packets::PacketHandler(dispatcher), m_Connection(connection), m_Version(2), m_ModInfoReceived(false)
{
...
void ForgeHandler::HandlePacket(protocol::packets::in::PluginMessagePacket* packet) {
