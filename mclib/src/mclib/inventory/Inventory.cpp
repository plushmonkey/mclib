...
void InventoryManager::HandlePacket(protocol::packets::in::ConfirmTransactionPacket* packet) {
    ...
    if (iter == m_Inventories.end()) {
        if (!accepted) {
            ...
            mc::protocol::packets::out::ConfirmTransactionPacket confirmation(windowId, action, false);
