...
PlayerManager::PlayerManager(protocol::packets::PacketDispatcher* dispatcher, entity::EntityManager* entityManager)
...
void PlayerManager::OnEntityMove(entity::EntityPtr entity, Vector3d oldPos, Vector3d newPos) {
    EntityId eid = entity->GetEntityId();
...
void PlayerManager::HandlePacket(protocol::packets::in::LoginSuccessPacket* packet) {
...
void PlayerManager::HandlePacket(protocol::packets::in::PlayerListItemPacket* packet) {
