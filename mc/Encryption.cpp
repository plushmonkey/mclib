...
private:
    ...
    Packets::Outbound::EncryptionResponsePacket* m_ResponsePacket;
    ...
    bool Initialize(const std::string& publicKey, const std::string& verifyToken) {
        ...
        m_ResponsePacket = new Packets::Outbound::EncryptionResponsePacket(encryptedSS, encryptedToken);
        return true;
    }
...
Packets::Outbound::EncryptionResponsePacket* EncryptionStrategyAES::GenerateResponsePacket() const {
